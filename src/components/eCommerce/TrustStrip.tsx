...
const TrustStrip = () => {
  return (
    <div className="hidden sm:block bg-gradient-to-r from-red-600 via-red-500 to-amber-500 border-b border-amber-400/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-2 sm:py-3 relative">
