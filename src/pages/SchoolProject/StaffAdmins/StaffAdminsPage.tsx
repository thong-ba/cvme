...
import { StaffAdminsDashboard } from '../../../components/school';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-emerald-50">
      <div className="mx-auto max-w-7xl px-4 py-6">
        ...
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Nhân viên (Staff Admins)</h1>
          <p className="text-slate-600">Quản lý thông tin nhân viên và vận hành hệ thống</p>
        </div>
        <StaffAdminsDashboard />
      </div>
    </div>
  );
};
