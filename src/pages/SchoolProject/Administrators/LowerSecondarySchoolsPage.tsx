import { lowerSecondarySchools } from '../../../data';

const LowerSecondarySchoolsPage = () => {
  return (
    <section className="px-4 pb-12 md:px-6 lg:px-10">
      <div className="mx-auto max-w-5xl rounded-2xl bg-white p-6 shadow-md">
        <header className="mb-4">
          <h1 className="text-2xl font-bold text-slate-900">Danh sách Trường THCS</h1>
          <p className="text-slate-600">Quản lý trường THCS, số lượng học sinh và trạng thái.</p>
        </header>
        <div className="grid gap-3 sm:grid-cols-2">
          {lowerSecondarySchools.map((school) => (
            <div
              key={school.id}
...
export default LowerSecondarySchoolsPage;
