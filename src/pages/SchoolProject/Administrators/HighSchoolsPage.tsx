    ...
    <section className="px-4 pb-12 md:px-6 lg:px-10">
      <div className="mx-auto max-w-5xl rounded-2xl bg-white p-6 shadow-md">
        <header className="mb-4">
          <h1 className="text-2xl font-bold text-slate-900">Danh sách Trường THPT</h1>
          <p className="text-slate-600">Kiểm soát quy mô, trạng thái kiểm định và số học sinh.</p>
        </header>
